...
static inline void  freen    ( void* a_ptr ) CRASH_INVEST_NOEXCEPT { :: free(a_ptr); }
static inline bool  SystemSpecificLibInitialRealloc  ( void*, size_t, void** a_ppReturn ) CRASH_INVEST_NODISCARD {*a_ppReturn=CRASH_INVEST_NULL;return false;}
static inline bool  SystemSpecificLibInitialDealloc( void* ) CRASH_INVEST_NOEXCEPT {return false;}
static inline void* SystemSpecificGlibcRealloc( void* a_ptr, size_t a_count ) CRASH_INVEST_NODISCARD { return :: realloc(a_ptr,a_count); }
static inline void  SystemSpecificGlibcDealloc( void* a_ptr ) CRASH_INVEST_NOEXCEPT { :: free(a_ptr); }
#else
